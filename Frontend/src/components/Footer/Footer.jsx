      ...
      fetch("http://127.0.0.1:5000/api/user/attendance", {
        ...
        .then((data) => {
          ...
          setUserData({
            name: data.name,
            email: data.Email,
            inTime: data.inTime, // replace with actual field from the backend
            outTime: data.outTime, // replace with actual field from the backend
          });
        })
        .catch((error) => {
  ...
  return (
    <footer className="bg-white">
      <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
        ...
        {/* Display user data in the component */}
